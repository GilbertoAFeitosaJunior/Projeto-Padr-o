...
<compress:html compressCss="true">
    ...
    <section class="panel">
        <header class="panel-heading">
            Pesquisar Coordenador Pedagógico
        ...
        <div class="panel-body">
            <s:form acceptcharset="UTF-8" method="post" action="listCoordenadorPedagogico" theme="simple">
                <div class="row">
    ...
    <section class="panel">
        ...
        <div class="panel-body">
            ...
            <table class="table table-striped table-advance table-hover table-bordered">
                ...
                <tbody>
                    <s:iterator value="coordenadorPedagogicos">
                        <tr>
    ...
    <script type="text/javascript">
                        ...
                        var list = {
                            add: function () {
                                window.location = "prepareCoordenadorPedagogico";
                            },
                            edit: function (id) {
                                window.location = "prepareCoordenadorPedagogico?coordenadorPedagogico.id=" + id;
                            },
                            remove: function (id) {
                                _helperID = id;
                            },
                            confirmDelete: function () {
                                window.location = "deleteCoordenadorPedagogico?coordenadorPedagogico.id=" + _helperID;
                            }
                        };
