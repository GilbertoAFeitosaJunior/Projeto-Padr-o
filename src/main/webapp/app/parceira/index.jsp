<%-- 
    Document   : index
    Created on : 27/11/2018, 12:00:39
...
<compress:html compressCss="true">
    ...
    <section class="panel">
        ...
        <div class="panel-body">
            <s:form acceptcharset="UTF-8" method="post" action="listParceira" theme="simple">
                <div class="row">
    ...
    <section class="panel">
        ...
        <div class="panel-body">
            ...
            <table class="table table-striped table-advance table-hover table-bordered">
                ...
                <tbody>
                    <s:iterator value="parceiras">
                        <tr>       
                            <td><s:property value="nome" /></td>
                            <td><s:property value="cnpjStringMask" /></td>
                            <td><s:property value="responsavelPrincipal" /></td>
    ...
    <script type="text/javascript">
                        ...
                        var list = {
                            add: function () {
                                window.location = "prepareParceira";
                            },
                            edit: function (id) {
                                window.location = "prepareParceira?parceira.id=" + id;
                            },
                            remove: function (id) {
                                _helperID = id;
                            },
                            confirmDelete: function () {
                                window.location = "deleteParceira?parceira.id=" + _helperID;
                            }
                        };
