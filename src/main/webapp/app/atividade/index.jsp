<%-- 
    Document   : index
    Created on : 16/11/2018, 14:20:58
    Author     : DEV-JAVA
--%>
...
<compress:html compressCss="true">
    ...
    <section class="panel">
        ...
        <div class="panel-body">
            <s:form acceptcharset="UTF-8" method="post" action="listAtividade" theme="simple">
                <div class="row">
    ...
    <script type="text/javascript">
                        ...
                        var list = {
                            add: function () {
                                window.location = "prepareAtividade";
                            },
                            edit: function (id) {
                                window.location = "prepareAtividade?atividade.id=" + id;
                            },
                            remove: function (id) {
                                _helperID = id;
                            },
                            confirmDelete: function () {
                                window.location = "deleteAtividade?atividade.id=" + _helperID;
                            }
                        };
