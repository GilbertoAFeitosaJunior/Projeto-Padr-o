...
<compress:html compressCss="true">
    ...
    <section class="panel">
        ...
        <div class="panel-body">
            <s:form acceptcharset="UTF-8" method="post" action="listGestorDoTerritorio" theme="simple">
                <div class="row">
    ...
    <script type="text/javascript">
                        ...
                        var list = {
                            add: function () {
                                window.location = "prepareGestorDoTerritorio";
                            },
                            edit: function (id) {
                                window.location = "prepareGestorDoTerritorio?gestorDoTerritorio.id=" + id;
                            },
                            remove: function (id) {
                                _helperID = id;
                            },
                            confirmDelete: function () {
                                window.location = "deleteGestorDoTerritorio?gestorDoTerritorio.id=" + _helperID;
                            }
                        };
