...
<compress:html compressCss="true">
    ...
    <section class="panel">
        ...
        <div class="panel-body">
            <s:form acceptcharset="UTF-8" method="post" action="listEscola" theme="simple">
                <div class="row">
    ...
    <script type="text/javascript">
                        ...
                        var list = {
                            add: function () {
                                window.location = "prepareEscola";
                            },
                            edit: function (id) {
                                window.location = "prepareEscola?escola.id=" + id;
                            },
                            remove: function (id) {
                                _helperID = id;
                            },
                            confirmDelete: function () {
                                window.location = "deleteEscola?escola.id=" + _helperID;
                            }
                        };
