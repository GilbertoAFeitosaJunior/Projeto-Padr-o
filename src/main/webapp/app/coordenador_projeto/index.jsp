...
<compress:html compressCss="true">
    ...
    <section class="panel">
        <header class="panel-heading">
            Pesquisar Coordenador de Projeto
        ...
        <div class="panel-body">
            <s:form acceptcharset="UTF-8" method="post" action="listCoordenadorDeProjeto" theme="simple">
                <div class="row">
    ...
    <section class="panel">
        ...
        <div class="panel-body">
            <table class="table table-striped table-advance table-hover table-bordered">
                ...
                <tbody>
                    <s:iterator value="coordenadorDeProjetos">
                        <tr>
    ...
    <script type="text/javascript">
                        ...
                        var list = {
                            add: function () {
                                window.location = "prepareCoordenadorDeProjeto";
                            },
                            edit: function (id) {
                                window.location = "prepareCoordenadorDeProjeto?coordenadorDeProjeto.id=" + id;
                            },
                            remove: function (id) {
                                _helperID = id;
                            },
                            confirmDelete: function () {
                                window.location = "deleteCoordenadorDeProjeto?coordenadorDeProjeto.id=" + _helperID;
                            }
                        };
