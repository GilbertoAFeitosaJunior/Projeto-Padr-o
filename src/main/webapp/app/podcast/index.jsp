...
<compress:html compressCss="true">
    ...
    <section class="panel">
        ...
        <div class="panel-body">
            <s:form acceptcharset="UTF-8" method="post" action="listUsuario" theme="simple">
                <div class="row">
    ...
    <script type="text/javascript">
                        ...
                        var list = {
                            add: function () {
                                window.location = "preparePodcast";
                            },
                            edit: function (id) {
                                window.location = "preparePodcast?podcast.id=" + id;
                            },
                            remove: function (id) {
                                _helperID = id;
                            },
                            confirmDelete: function () {
                                window.location = "deletePodcast?podcast.id=" + _helperID;
                            }
                        };
