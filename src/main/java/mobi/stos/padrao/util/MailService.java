...
public class MailService {
    ...
    public MailService() throws Exception {
        try {
            ...
            this.ssl = Boolean.parseBoolean(props.getProperty("mail.ssl"));
    ...
    public void enviarEmail(Email email) throws Exception {
        ...
        Mailer mailer = new Mailer(this.smtp, this.port, this.user, this.password, this.ssl ? TransportStrategy.SMTP_SSL : TransportStrategy.SMTP_PLAIN);
