package mobi.stos.educador.common;

import com.google.common.base.Preconditions;
import java.io.Serializable;
import java.util.List;
import mobi.stos.educador.util.consulta.Consulta;
import mobi.stos.educador.util.consulta.HibernateAlias;
...
public abstract class AbstractHibernateDao<T extends Serializable> implements IOperations<T> {
    ...
    public List<T> list(final Consulta consulta) {
        ...
        consulta.getCondicaoConsulta().forEach((criterion) -> {
        ...
        if (consulta.getOrders() != null && !consulta.getOrders().isEmpty()) {
            consulta.getOrders().forEach((order) -> {
